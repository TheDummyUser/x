...
const Header = () => {
  return (
    ...
    <div className='cursor-pointer flex space-x-6 text-sm md:text-xl lg:text-xl underline '>
      ...
      <Link activeClass="active" to="projects" spy={true} smooth={true} offset={-100} duration={500} className='transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:text-indigo-500 duration-300'>Projecs</Link>
